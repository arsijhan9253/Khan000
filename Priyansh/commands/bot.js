...
if ((event.body.toLowerCase() == "koi h kya") || (event.body.toLowerCase() == "koi h kiya") || (event.body.toLowerCase() == "koi hai kiya") || (event.body.toLowerCase() == "Koi hai kya")) {
     return api.sendMessage("mai hu na janeman 🙂🤟", threadID);
   };
...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("Ꮆɵɵɗ Ɱ❍ɽƞɪɪƞɠ baby☕✨💫", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ayesha") || (event.body.toLowerCase() == "ayesha khan") || (event.body.toLowerCase() == "AYESHA") || (event.body.toLowerCase() == "Ayesha")) {
     return api.sendMessage( " Ayesha bhot pyari ladki hai sab esa bolte hai 🥰🥰",threadID);
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "asslam alaikum") || (event.body.toLowerCase() == "Asslamu alaikum") || (event.body.toLowerCase() == "ASSLAM ALAIKUM")) {
    return api.sendMessage("️WA ALAIKUM ASSLAM🌹😇", threadID);
   };
...
if ((event.body.toLowerCase() == "I love you") || (event.body.toLowerCase() == "Love you ")) {
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("🦋ESE HI HASTE RHA KARO HMEASHA 🕊️🍎😍", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "fuck") || (event.body.toLowerCase() == "Fuck")) {
     return api.sendMessage("🏔️🏝️Ayesha Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣo Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };
